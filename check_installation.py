...
req = {
    "python", "nb_conda_kernels", "pip", "ipython", "tqdm", "numpy", "scipy", "pandas", "scikit-learn", 
    "statsmodels", "scikit-surprise", "umap-learn", "fbprophet", "matplotlib", "seaborn", "ipywidgets", 
    "plotly", "networkx", "nltk", "gensim", "torchtext", "pytorch", "torchvision", "pillow", "pyclustering", 
    "beautifulsoup4", "selenium", "psycopg2", "flask", "flask-cors", "python-dotenv", "xgboost", "scikit-optimize", 
    "pmdarima", "jcopml", "luwiji", "jcopdl", "kmodes", "opencv-python", "gym"
}
env_name = "env_scrap"
working_folder = "project-google-play-app-reviews"
env_file = "env_scrap.yml"
